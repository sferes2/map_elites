...
// this header can be included in your project to load maps generated by
// map-elites in binary (whithout any loss of precision)
...
static void write(const std::vector<Elem> &m, const std::string &filename) {
...
static std::vector<Elem> load(const std::string &filename) {
